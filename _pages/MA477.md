...
<html>
<body>
<h3><font color='red'>Guidelines:</font></h3>
Downloading JupyterNotebooks: JupyterNotebooks seem not to be properly compiled within GitHub enviroment, so as a result they do not display properly. I recommend either viewing the marked down file (the file with extension .md) or downloading the Notebooks.
<br>

To download the JupyterNotebooks follow the steps below:
<ul>
<li>  Click on the tab Raw</li>
<li>  Right click on the page and select Save As</li>
<li>  Change Save as type: to All Files</li>
<li>    Save the file to your designated folder and manually add the extension .ipynb </li>
</ul>
<h3>Admin</h3>
